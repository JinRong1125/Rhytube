...
//    }
  ...
  paint(Canvas canvas) {
    ...
    canvas.drawAtlas(image, transforms, rects, colors,
...
ParticleSystem deserializeParticleSystem(Map data, {ParticleSystem particleSystem, Image image}) {
